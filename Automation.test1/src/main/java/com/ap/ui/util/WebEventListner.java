...
is to override all the methods and define creating helpful capture actions which 
would be displayed/logged as the application under test is being executed. These method will be invoked
...
try {
TestUtil.takeScrkeScreenshotAt();
} catch (IOException e) {
e.printStackTrace();
}
}
